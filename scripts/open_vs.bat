...
REM
REM Generation targets %LOCALAPPDATA%\MathematicsBuild\vs2026 rather than the repo:
...
set "SLNDIR=%LOCALAPPDATA%\MathematicsBuild\vs2026"
...
set "SLN="
if exist "%SLNDIR%\Mathematics.slnx" set "SLN=%SLNDIR%\Mathematics.slnx"
if not defined SLN if exist "%SLNDIR%\Mathematics.sln" set "SLN=%SLNDIR%\Mathematics.sln"
