...
| 구현 | MSVC | clang |
|------|------|-------|
| Mathf | 42.8 M/s | 71.5 M/s |
| DirectXMath | 68.5 M/s | 78.8 M/s |
| GLM | 44.6 M/s | 47.9 M/s |

**MSVC에서 38%, clang에서 9% 뒤진다.** 원인은 명확하다 — 우리 구현은 완전히
스칼라(라플라스 여인수 전개, 약 150회 연산)이고 DXMath는 SIMD다. GLM보다는 빠르다.

> **다음 과제**: SIMD 역행렬. 여인수를 4개씩 묶어 계산하면 벡터 연산 약 40회로
> 줄어든다. 이것이 Phase 3의 유일한 미완 항목이다.
