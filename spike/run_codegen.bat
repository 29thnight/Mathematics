@echo off
REM Emits assembly listings for the codegen spike so Mathematics' output can be
...
echo === MSVC /FA ===
cl /nologo /std:c++20 /O2 /EHsc /arch:AVX2 /fp:fast /c "%source_dir%codegen_vs_dxmath.cpp" ^
...
clang-cl /nologo /std:c++20 /O2 /EHsc /arch:AVX2 /fp:fast /c "%source_dir%codegen_vs_dxmath.cpp" ^
